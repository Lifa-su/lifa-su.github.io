...
- `lifa-su.github.io` is stale because GitHub Pages only publishes what reaches `origin/main`, and local `main` is currently ahead of `origin/main` by `257` commits with additional uncommitted page changes.
...
- Are the `257` local commits intentionally unpublished, or should they be pushed now?
